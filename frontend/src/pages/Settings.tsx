        ...
        <div className="settings-sidebar">
          ...
          {versionInfo && (
            <div style={{
              ...
              <span>Geist v{versionInfo.version}</span>
              <div style={{ display: 'flex', gap: '0.5rem' }}>
                <a
                  href="https://github.com/geist-app/geist/blob/main/CHANGELOG.md"
                  target="_blank"
                ...
                <span>•</span>
                <a
                  href="https://github.com/geist-app/geist"
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ color: 'var(--primary)', textDecoration: 'none' }}
                >
            ...
            <>
              ...
              <div className="settings-section">
                ...
                <div className="settings-form-group">
                  ...
                  />
                  <p className="hint">
                    Pick a unique topic name (e.g., geist-myname-123). Then subscribe to it in the{' '}
          ...
          {activeSection === 'admin' && profile?.is_admin && (
            <>
              <div className="settings-section">
                ...
                <p className="settings-section-description">
                  Configure system-wide settings for Geist.
                </p>
